...
from data.edis_dataset import edis_train, edis_retrieval_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='retrieval_edis':
        train_dataset = edis_train(transform_train, config['image_root'], config['ann_root'])
        val_dataset = edis_retrieval_eval(transform_test, config['image_root'], config['ann_root'], 'val')
        test_dataset = edis_retrieval_eval(transform_test, config['image_root'], config['ann_root'], 'test')
        return train_dataset, val_dataset, test_dataset
